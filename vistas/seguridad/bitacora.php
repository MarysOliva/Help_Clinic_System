            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                        <td class="desaparecerTemporalmente">1</td>
                        <td class="desaparecerTemporalmente1">14/11/2022 7:00:00am</td>
                        <td class="desaparecerTemporalmente1">DAVID</td>
                        <td class="desaparecerTemporalmente1">EDITO</td>
                        <td class="desaparecerTemporalmente1">ESPECIALIDADES</td>
                        <td>ESPECIALIDAD</td>
                        <td>1</td>
                        <td>DERMATOLOGÍA</td>
                        <td>CARDIOLOGÍA</td>
