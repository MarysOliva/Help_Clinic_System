...
<!-- El Modal -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Nuevo Parametro</h4>
  ...
  <form action="" method="post">
                <div class="modal-body">
                    ...
                    <label for="">Parametro:</label>
                    <input value="Intentos"  type="text"  class="form-control" name="sector_comercial"  required value="" placeholder="" id="txtsectorcomercial" autocomplete = "off" onkeypress="return soloLetras(event);" minlength="4" maxlength="50" onkeyup="mayus(this);" >
                    <br>
                    <label for="">Valor:</label>
                    <input value="3"  type="text" class="form-control" name="" id="">
                    <br>
                    
                     <label for="">Fecha de modificación:</label>
                    <input type="text" value="15/11/2022" readonly class="form-control">
                    <br>
                </div>
                <!-- Fin Cuerpo del modal Modal -->
                      ...
                      <button  value="eliminar" name="accion" 
                        ...
                        <i class="fas fa-trash-alt"></i>
                                         ...
                                         <td class="desaparecerTemporalmente1">Intentos</td>
                                         <td class="desaparecerTemporalmente1">3</td>
