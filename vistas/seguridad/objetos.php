              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <th class="desaparecerTemporalmente1">Objeto</th>
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <label for="">Objeto</label>
                    <input  type="email" class="form-control"   value="Medicos" placeholder=""   autocomplete = "off" >
                    <br>
                    <label for="">Descripcion:</label>
                    <input type="text" value="Pantalla de medicos " class="form-control" name="" id="">
                    <br>
                ...
                <!-- Fin Cuerpo del modal Modal -->
                      ...
                      <button  value="eliminar" name="accion" 
                        ...
                        <i class="fas fa-trash-alt"></i>
                                         ...
                                         <td class="desaparecerTemporalmente1"> Medicos</td>
                                         <td class="desaparecerTemporalmente1">Pantalla Medicos</td>
