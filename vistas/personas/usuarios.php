            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <label for="">Usuario:</label>
                    <input type="text" onkeyup="un_espacio(this);" class="form-control" name="nombre"  value="ADMIN" required value="" placeholder="" id="text" autocomplete = "off" onkeypress="return soloLetras(event);" minlength="4" maxlength="50" onkeyup="mayus(this);" >
                    <br>
                    <label for="">Rol:</label>
                    <select name="" class="form-control"  id="">
                    ...
                    <label for="">Nombres:</label>
                    <input type="text" value="DAVID" class="form-control" name="sector_comercial"   required value="" placeholder="" id="txtsectorcomercial" autocomplete = "off" onkeypress="return soloLetras(event);" minlength="4" maxlength="50" onkeyup="mayus(this);" >
                    <br>
                    <label for="">Apellidos:</label>
                    <input type="text" value="SANCHEZ" class="form-control" name="" id="">
                    <br>
                    <label for="">Teléfono</label>
                    ...
                    <br>
                    <label for="">DNI</label>
                    <input  type="email" class="form-control"   value="08010000222772" placeholder=""   autocomplete = "off" >
                    <br>
                </div>
                <!-- Fin Cuerpo del modal Modal -->
