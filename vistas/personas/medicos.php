        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input value=""  type="text" class="form-control" name="telefono"  placeholder="" id="txttelefono" autocomplete = "off" required minlength="8" maxlength="8" placeholder="" pattern="[0-9]+[1-9]+[0-9]+" title="8 caracteres y no todos ceros" onkeypress="return solonumero(event)" >
                    <br>
                    <label for="">Correo:</label>
                    <input value=""  type="email" class="form-control" minlength="3" maxlength="50" name="correo" required  placeholder="" id="txtcorreo"  autocomplete = "off" >
                    <br>
                    <label for="">DNI:</label>
                    <input value=""  type="email" class="form-control" minlength="3" maxlength="50" name="correo" required  placeholder="" id="txtcorreo"  autocomplete = "off" >
                    <br>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <label for="">Nombres:</label>
                    <input value="DAVID"  type="text"  class="form-control" name="sector_comercial"  required value="" placeholder="" id="txtsectorcomercial" autocomplete = "off" onkeypress="return soloLetras(event);" minlength="4" maxlength="50" onkeyup="mayus(this);" >
                    <br>
                    <label for="">Apellidos:</label>
                    <input value="SANCHEZ"  type="text" class="form-control" name="" id="">
                    <br>
                    <label for="">Teléfono:</label>
                    <input value="8965777"  type="text" class="form-control" name="telefono"  placeholder="" id="txttelefono" autocomplete = "off" required minlength="8" maxlength="8" placeholder="" pattern="[0-9]+[1-9]+[0-9]+" title="8 caracteres y no todos ceros" onkeypress="return solonumero(event)" >
                    <br>
                    <label for="">Correo:</label>
                    ...
                    <br>
                    <label for="">DNI:</label>
                    <input value="08010000222772"  type="email" class="form-control" minlength="3" maxlength="50" name="correo" required  placeholder="" id="txtcorreo"  autocomplete = "off" >
                    <br>
                    <label for="">Dirección:</label>
                    <input  value="Dirección"  type="email" class="form-control" minlength="3" maxlength="50" name="correo" required  placeholder="" id="txtcorreo"  autocomplete = "off" >
                    <br>
                     <label for="">Especialidad:</label>
                    <select name="" class="form-control"  id="">
                      <option value="">Cardiología</option>
                ...
                <!-- Fin Cuerpo del modal Modal -->
                      ...
                      <button  value="eliminar" name="accion" 
                        ...
                        <i class="fas fa-trash-alt"></i>
                                         ...
                                         <td class="desaparecerTemporalmente1">Dirección</td>
