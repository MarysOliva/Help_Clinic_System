...
<!-- El Modal -->
  ...
  <form action="" method="post">
                <div class="modal-body">
                    ...
                    <label for="">Especialidad:</label>
                    <input value="CARDIOLOGÍA"  type="text"  class="form-control" name="sector_comercial"  required value="" placeholder="" id="txtsectorcomercial" autocomplete = "off" onkeypress="return soloLetras(event);" minlength="4" maxlength="50" onkeyup="mayus(this);" >
                    <br>
                    <label for="">Descripción:</label>
                    <input value="DESCRIPCIÓN"  type="text" class="form-control" name="" id="">
                    <br>
                ...
                <!-- Fin Cuerpo del modal Modal -->
                      ...
                      <button  value="eliminar" name="accion" 
                        ...
                        <i class="fas fa-trash-alt"></i>
                                         ...
                                         <td class="desaparecerTemporalmente1">DESCRIPCIÓN</td>
